...
for(const theme of ['classic','red','white']){
 ...
 body+=t('SEMANA DE APERTURA',108,1308,24,promoInk)+t('Hot dog + Coca-Cola de vidrio',108,1365,41,promoInk,'display',660)+t('Tradicional o combinado',108,1411,29,promoInk,'body',650)+t('Incluye una Coca-Cola de vidrio.',108,1447,25,promoInk,'body',650)+t('$75',970,1392,83,promoInk,'display',200,'right');
